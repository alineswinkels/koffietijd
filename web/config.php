...
if (!preg_match('/^(127\.0\.0\.1|::1|192\.168\.2\.\d+)$/', @$_SERVER['REMOTE_ADDR'])) {
                ...
                <div class="block">
                    <div class="symfony-block-content">
                        ...
                        <ul class="symfony-install-continue">
                            <?php if (!count($majorProblems)): ?>
                                <li><a href="app_debug.php/_configurator/">Configure your Symfony Application online</a></li>
                                <li><a href="app_debug.php/">Bypass configuration and go to the Welcome page</a></li>
                            <?php endif; ?>
                            <?php if (count($majorProblems) || count($minorProblems)): ?>
